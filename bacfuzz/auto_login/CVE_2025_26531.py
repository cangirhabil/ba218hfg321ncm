...
def run_admin(playwright: Playwright, config) -> None:
    ...
    page.goto("http://localhost:8088/login/index.php")
...
def run_2(playwright: Playwright, config) -> None:
    ...
    page.goto("http://localhost:8088/login/index.php")
    page.get_by_placeholder("Username").click()
    page.get_by_placeholder("Username").fill("manager")
    page.get_by_placeholder("Password").click()
    page.get_by_placeholder("Password").fill("Manager123#")
    page.get_by_placeholder("Password").press("Enter")
...
def run_3(playwright: Playwright, config) -> None:
    ...
    page.goto("http://localhost:8088/login/index.php")
    page.get_by_placeholder("Username").click()
    page.get_by_placeholder("Username").fill("teacher")
    page.get_by_placeholder("Password").click()
    page.get_by_placeholder("Password").fill("Teacher123#")
    page.get_by_placeholder("Password").press("Enter")
    
    page.wait_for_timeout(3000);

    config.homepages['Teacher'] = page.url
    page.context.storage_state(path=f"{folder_name}/Teacher.json")
    # ---------------------
    context.close()
    browser.close()
...
def run_4(playwright: Playwright, config) -> None:
    ...
    page.get_by_placeholder("Password").click()
    page.get_by_placeholder("Password").fill("Student123#")
    page.get_by_placeholder("Password").press("Enter")
    
    page.wait_for_timeout(3000);

    config.homepages['Student'] = page.url
    page.context.storage_state(path=f"{folder_name}/Student.json")
    # ---------------------
    context.close()
    browser.close()
...
def run_5(playwright: Playwright, config) -> None:
    ...
    page.goto("http://localhost:8088/login/index.php")
    page.get_by_placeholder("Username").click()
    page.get_by_placeholder("Username").fill("gueststar")
    page.get_by_placeholder("Password").click()
