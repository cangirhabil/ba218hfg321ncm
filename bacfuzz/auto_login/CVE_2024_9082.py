...
def run_admin(playwright: Playwright, config) -> None:
    ...
    page.goto("http://localhost:8088/oews/admin/login.php")
...
def run_2(playwright: Playwright, config) -> None:
    ...
    page.goto("http://localhost:8088/oews/admin/login.php")
    page.get_by_placeholder("Username").click()
    page.get_by_placeholder("Username").fill("userf")
    page.get_by_placeholder("Password").click()
    page.get_by_placeholder("Password").fill("fuzzer")
    page.get_by_placeholder("Password").press("Enter")
...
def run_Anonymous(playwright: Playwright, config) -> None:
    ...
    context = browser.new_context()
    page = context.new_page()
    page.goto("http://localhost:8088/oews")
