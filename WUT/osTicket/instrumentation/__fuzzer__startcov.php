...
if (!getenv("FUZZER_SETUP") && isset($_SERVER['HTTP_X_FUZZER_COVID'])) {
	...
	function __fuzzer__debug($string) {
		// ARYA EDIT; add a timestamp for the debug information
		file_put_contents("/shared-tmpfs/debug.log", date("Y-m-d H:i ").$string, FILE_APPEND);
	}
	...
	include __DIR__ . "/overrides.d/01_exceptions.php";
	include __DIR__ . "/overrides.d/arya_mysql_catch.php";
	include __DIR__ . "/overrides.d/new_function.php";
	// ------------------------------
