...
--
-- Host: db
-- Generation Time: May 17, 2025 at 09:27 AM
...
CREATE TABLE `applied_leave` (
  ...
  `e_leave` int NOT NULL,
  `m_leave` int NOT NULL,
  `c_leave` int NOT NULL,
  `apply_by` int NOT NULL,
...
(3, 'admin', 'admin@local.co', '0192023a7bbd73250516f069df18b500', 'Admin', 'admin', '2025-05-17 09:26:41'),
(4, 'employee', 'employee@local.co', '033836b6cedd9a857d82681aafadbc19', 'Employee', 'employee', '2025-05-17 09:26:29'),
